...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "rain analysis, and column process-event sliding."
        )
    )
    parser.add_argument(
        "--input-file",
    ...
    parser.add_argument(
        ...
        help="Vertical thickness of the sliding-column moving window in metres.",
    )
    parser.add_argument(
        "--window-step-m",
        type=float,
        default=WINDOW_STEP_M,
        help="Vertical step of the sliding-column moving window in metres.",
    )
    parser.add_argument(
        "--dpi",
        type=int,
    ...
    print(f"Column analysis : automatic whole-sliding column")
